...
export default function Nav({ isLight = true }: { isLight?: boolean }) {
...
function NavTitle({ color, style }: { color: string; style?: Record<string, string | number> }) {
    return (
        <svg
            className={styles.navTitle}
            style={{ ...style, mixBlendMode: "difference" }}
            width="79"
            height="43"
            viewBox="0 0 79 43"
            fill="none"
