...
const WORK = [
	{
		...
		note: `Built from scratch the client side of the web application equivalent of the Prodeus <a href='https://chrome.google.com/webstore/detail/prodeus/aglakbhkijgpmoploegcpnbnedgiampn' target='_blank' rel='noreferrer'>Google chrome extension </a>,
	...
	},
	{
		...
		note: `Wroked with <a href="https://www.upwork.com/ag/mpaccione/" target="_blank" rel="noreferrer">M.Paccione Design & Development Agency</a> to bring ideas to life. Also occasionally dive into side projects when the need arises since skilled hands are always needed. More freelance projects are shown soon in the projects section.`,
	},
	{
        ...
        <li>Custom checkout/payment system integrated with <a href="https://squareup.com/us/en" target="_blank" rel="noreferrer">Square</a></li>
	...
	},
	{
		...
		note: `Converted UI/UX designs to functional web application pages on a contract base, after which moved on to integrate more features into the <a href="https://cloud.liveizy.com/" target="_blank" rel="noreferrer">Liveizy platform</a>`,
	},
	{
		title: "Front End Developer (Remote)",
		company: "Sumosoft",
		...
		note: `Developed new user interfaces for the clients <a href="https://www.richard-james.com/" target="_blank" rel="noreferrer">Richard James</a> and <a href="https://www.archibaldlondon.com/" target="_blank" rel="noreferrer">Archibald London</a>  using mockups provided by a UI/UX designer as guide.`,
	},
];
